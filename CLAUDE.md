...
- `docs/TRAIN.md` is the live board for the release currently being built. A PR that starts, finishes, or drops a milestone updates its row **in the same PR**; check it before picking up work so two sessions never build the same thing.
